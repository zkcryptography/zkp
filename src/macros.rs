...
macro_rules! define_proof {
    (
        ...
        pub mod $proof_module_name {
            ...
            pub fn new() -> $proof_module_name {
                $proof_module_name{}
            }

            impl $proof_module_name {
            ...
            // impl<A> IsSigmaProtocol<A> for $proof_module_name
            // where
            //     A: IsProverAssignments {
            //     type Proof = BatchableProof;

            //     fn commit(&mut self, assignments: A) -> Result<(), ProofError> {
            //         Ok(())
            //     }
            ...
            //     fn response(&mut self, challenge: Scalar, assignments: A) -> Self::Proof {
            //         BatchableProof{
            //             challenges: vec![],
            //             commitments: vec![],
            //             responses: vec![]
            //         }
            //     }
            //     fn simulate(&mut self, assignments: A) -> (Vec<Scalar>, Vec<Scalar>) {
            //         (vec![], vec![])
            //     }
            // }
